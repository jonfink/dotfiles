...
;; My color theme is below...
(defun color-theme-jon ()
  ...
  (color-theme-install
   '(color-theme-jon
     ...
     ;;(modeline ((t (:background "Gray10" :foreground "LightGray" :box (:line-width 1 :style none) :width condensed :family "neep"))))
     (modeline ((t (:background "Gray10" :foreground "LightGray" :box (:line-width 1 :style none) :width condensed))))
     ;;(modeline-buffer-id ((t (:background "Gray10" :foreground "LightGray" :box (:line-width 1 :style none) :width condensed :family "neep"))))
     (modeline-buffer-id ((t (:background "Gray10" :foreground "LightGray" :box (:line-width 1 :style none) :width condensed))))
     ;;(modeline-mousable-minor-mode ((t (:background "Gray10" :foreground "LightGray" :box (:line-width 1 :style none) :width condensed :family "neep"))))
     (modeline-mousable-minor-mode ((t (:background "Gray10" :foreground "LightGray" :box (:line-width 1 :style none) :width condensed))))
     ;;(modeline-mousable ((t (:background "Gray10" :foreground "LightGray" :box (:line-width 1 :style none) :width condensed :family "neep"))))
     (modeline-mousable ((t (:background "Gray10" :foreground "LightGray" :box (:line-width 1 :style none) :width condensed))))
